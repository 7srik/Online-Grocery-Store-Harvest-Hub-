...
public class CheckoutController extends ProductBController {
	...
	@FXML
	void alterStore(ActionEvent event) {
		deliveryStatus = true;
		addressField.setDisable(deliveryStatus);
		
	}
	
	@FXML
	void alterHome(ActionEvent event) {
